...
- (void)viewDidLoad 
{
    ...
    self.maxSelectSize = self.maxSelectSize >=0 ? self.maxSelectSize : 0;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [_manager requestImageForAsset:asset targetSize:CGSizeMake(200, 200) contentMode:PHImageContentModeAspectFill options:option resultHandler:^(UIImage* _Nullable result, NSDictionary* _Nullable info) {
...
{    
    ...
    else
    {
        ...
        else if(self.maxSelectSize != 0 && [self assetFileSize:asset] > self.maxSelectSize) 
        {
            [self alertSize];
        }
        else 
